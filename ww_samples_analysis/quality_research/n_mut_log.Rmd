...
print(nmut)
ggplot(nmut)+
  geom_point(aes(y = log10(identified), x = frequencies, col = "red"))+
  geom_point(aes(y = log10(not_id), x = frequencies, col = "blue"))+
  scale_y_continuous(name="Number of mutations(log10)")+
  theme(legend.position="none")
